...
public final class AFailedOsuccessExpr extends POsuccessExpr
{
    private POidRef _oidRef_;

    public AFailedOsuccessExpr()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFailedOsuccessExpr(
    ...
    {
        ((Analysis) sw).caseAFailedOsuccessExpr(this);
    }
