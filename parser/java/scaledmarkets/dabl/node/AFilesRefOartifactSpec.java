...
public final class AFilesRefOartifactSpec extends POartifactSpec
{
    private POidRef _oidRef_;

    public AFilesRefOartifactSpec()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFilesRefOartifactSpec(
    ...
    {
        ((Analysis) sw).caseAFilesRefOartifactSpec(this);
    }
