package com.scaledmarkets.dabl.helper;
...
public class Helper {
	 ...
	 */
	public POartifactSpec findArtifactSpecForTask(String taskName,
			String outputsName) throws Exception {
		ANamedOnamedArtifactSet namedArtifactSet = getNamedOutput(
			taskName, outputsName);
		POartifactSpec p = namedArtifactSet.getOartifactSpec();
		return p;
	}
	...
	public List<ValueType> getFunctionDeclTypes(AOfunctionDeclaration funcDecl) {
		...
		return LanguageCoreAnalyzer.getFunctionDeclTypes(funcDecl);
	}
	...
	public List<ValueType> getFunctionCallTypes(AFuncCallOprocStmt funcCall) {
		...
		return LanguageCoreAnalyzer.getFunctionCallTypes(state, funcCall);
	}
