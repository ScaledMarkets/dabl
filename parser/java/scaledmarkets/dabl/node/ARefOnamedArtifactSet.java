...
public final class ARefOnamedArtifactSet extends POnamedArtifactSet
{
    private POidRef _oidRef_;

    public ARefOnamedArtifactSet()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ARefOnamedArtifactSet(
    ...
    {
        ((Analysis) sw).caseARefOnamedArtifactSet(this);
    }
