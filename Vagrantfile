# For creating a local Linux VM in which we can deploy and test, which
# requires Docker.

Vagrant.configure(2) do |config|

	config.vm.hostname = "dabl"
	...
	#config.vm.synced_folder "~/Transient/DABL", "/Transient", create: true
