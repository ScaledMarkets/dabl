...
public final class ASucceededOsuccessExpr extends POsuccessExpr
{
    private POidRef _oidRef_;

    public ASucceededOsuccessExpr()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASucceededOsuccessExpr(
    ...
    {
        ((Analysis) sw).caseASucceededOsuccessExpr(this);
    }
